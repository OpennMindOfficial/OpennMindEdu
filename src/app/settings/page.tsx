  ...
  return (
    <div className="flex h-screen bg-background text-foreground overflow-hidden">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        <Header />
        <motion.main
          className="flex-1 overflow-y-auto p-6 md:p-8 lg:p-10 space-y-6 bg-muted/30 dark:bg-muted/10" // Slightly different background
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
                         ...
                         <div className="flex items-center space-x-4">
                            <Avatar className="w-16 h-16">
                              {profileImage ? (
                                ...
                                // Placeholder if no image - could be initials or icon
                                <AvatarFallback className="bg-muted text-muted-foreground">
                                  <User size={32} />
                                </AvatarFallback>
                                // Or use a placeholder image path:
                              ...
                              <div>
                                  ...
                                  <div className="relative">
                                      <Input
                                        ...
                                        id="current-password"
                                        // For demo, we are not storing or checking the current password
                                        // value={currentPassword}
                                        // onChange={(e) => setCurrentPassword(e.target.value)}
                                        placeholder="Enter current password" // More appropriate placeholder
                                        className="bg-background dark:bg-input rounded-lg shadow-sm pr-10" // Add padding for icon
                                      />
                                      <Button
                                          type="button"
                                          variant="ghost"
